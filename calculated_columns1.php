 ...
 */
    ...
    class v_calculated_columns1Page extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Calculated Columns.Example - 1');
            $this->SetMenuLabel('Example - 1');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_calculated_columns1`');
            $this->dataset->addFields(
                array(
                    ...
                    new StringField('full_name', false, false, false, true),
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/calculated_columns1.html"));
            
            $this->setDetailedDescription(
                '// server-side event' .
                extractMethodCode($this, 'doCalculateFields') .    
                '<br>' .
                '// client-side event' .                                      
                extractClientEventCode($this, 'OnCalculateControlValues')
            );
        }
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'full_name', 'full_name', 'Full Name'),
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('full_name', 'full_name', 'Full Name', $this->dataset);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new StaticEditor('full_name_edit');
            ...
            //
            $editor = new StaticEditor('age_edit');
        ...
        protected function setClientSideEvents(Grid $grid) {
            $grid->setCalculateControlValuesScript('editors[\'full_name\'].setValue(editors[\'first_name\'].getValue() + \' \' + editors[\'last_name\'].getValue());
    ...
    try
    {
        $Page = new v_calculated_columns1Page("v_calculated_columns1", "calculated_columns1.php", GetCurrentUserPermissionsForPage("v_calculated_columns1"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_calculated_columns1"));
