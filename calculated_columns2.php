 ...
 */
    ...
    class v_calculated_columns2Page extends Page
    {
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('last_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_v_calculated_columns2_customer_id_search', 'id', 'last_name', null, 20);
            ...
            $lookupDataset->setOrderByField('last_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_v_calculated_columns2_customer_id_search', 'id', 'last_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('last_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_v_calculated_columns2_customer_id_search', 'id', 'last_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('last_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_v_calculated_columns2_customer_id_search', 'id', 'last_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
