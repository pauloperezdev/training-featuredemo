 ...
 */
    ...
    class v_charts_barPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Charts.Bar');
            $this->SetMenuLabel('Bar Chart');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/charts_bar.html"));
        }
        ...
        {
            $chart = new Chart('bar-chart', Chart::TYPE_BAR, $this->dataset);
            $chart->setTitle('Population (in thousands) and Gross national product by continent');
            $chart->setHeight(300);
            $chart->setDomainColumn('Continent', 'Continent', 'string');
            $chart->addDataColumn('Population', 'Population', 'float');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'Population', 'Population', 'Population (in thousands)'),
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new NumberViewColumn('Population', 'Population', 'Population (in thousands)', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(2);
            $column->setThousandsSeparator(',');
            $column->setDecimalSeparator('.');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new CustomEditColumn('Population (in thousands)', 'Population', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
    ...
    try
    {
        $Page = new v_charts_barPage("v_charts_bar", "charts_bar.php", GetCurrentUserPermissionsForPage("v_charts_bar"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_charts_bar"));
