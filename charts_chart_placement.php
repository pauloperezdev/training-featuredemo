 ...
 */
    ...
    class v_charts_chart_locationPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Charts.Chart Placement');
            $this->SetMenuLabel('Chart Placement');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_charts_chart_location`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/charts_chart_placement.html"));
        }
        ...
        protected function setupCharts()
        {
            ...
            order by 2 desc
            limit 10';
            $chart = new Chart('country-by-population', Chart::TYPE_COLUMN, $this->dataset, $sql);
            $chart->setTitle('Top 10 countries by population');
            $chart->setHeight(300);
            $chart->setDomainColumn('name', 'name', 'string');
            $chart->addDataColumn('population', 'Population', 'int');
            $this->addChart($chart, 0, ChartPosition::AFTER_GRID, 6);
            ...
            order by 2 desc
            limit 10';
            $chart = new Chart('country-by-life-expectancy', Chart::TYPE_BAR, $this->dataset, $sql);
            ...
            order by 2 desc
            limit 10';
            $chart = new Chart('country-by-gnp', Chart::TYPE_COLUMN, $this->dataset, $sql);
            $chart->setTitle('Top 10 countries by GNP (gross national product)');
            $chart->setHeight(300);
            $chart->setDomainColumn('name', 'name', 'string');
            $chart->addDataColumn('gnp', 'GNP', 'float');
            $this->addChart($chart, 1, ChartPosition::AFTER_GRID, 6);
        }
    ...
    try
    {
        $Page = new v_charts_chart_locationPage("v_charts_chart_location", "charts_chart_placement.php", GetCurrentUserPermissionsForPage("v_charts_chart_location"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_charts_chart_location"));
