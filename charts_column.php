 ...
 */
    ...
    class v_charts_columnPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Charts.Column');
            $this->SetMenuLabel('Column Chart');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/charts_column.html"));
        }
        ...
        {
            $chart = new Chart('population', Chart::TYPE_COLUMN, $this->dataset);
    ...
    try
    {
        $Page = new v_charts_columnPage("v_charts_column", "charts_column.php", GetCurrentUserPermissionsForPage("v_charts_column"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_charts_column"));
