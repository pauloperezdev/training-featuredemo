 ...
 */
    ...
    class q_life_expectancy_by_countryPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Charts.Geo');
            $this->SetMenuLabel('Geo Charts');
    
            $selectQuery = 'select
              Code2, Name, LifeExpectancy
            from
              country
            where
            ...
            $this->dataset = new QueryDataset(
              ...
              $selectQuery, $insertQuery, $updateQuery, $deleteQuery, 'q_life_expectancy_by_country');
            $this->dataset->addFields(
                array(
                    new StringField('Code2', true, true),
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/charts_geo.html"));
        }
        ...
        {
            $chart = new Chart('life-expectancy-by-country', Chart::TYPE_GEO, $this->dataset);
            $chart->setTitle('Life Expectancy by Country');
            $chart->setHeight(400);
            $chart->setDomainColumn('Code2', 'Code2', 'string');
    ...
    try
    {
        $Page = new q_life_expectancy_by_countryPage("q_life_expectancy_by_country", "charts_geo.php", GetCurrentUserPermissionsForPage("q_life_expectancy_by_country"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("q_life_expectancy_by_country"));
