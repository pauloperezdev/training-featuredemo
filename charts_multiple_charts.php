 ...
 */
    ...
    class v_charts_multiple_chartsPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Charts.Multiple Charts');
            $this->SetMenuLabel('Multiple Charts');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_charts_multiple_charts`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/charts_multiple_charts.html"));
        }
        ...
        protected function setupCharts()
        {
            ...
            order by 2 desc
            limit 10';
            $chart = new Chart('country-by-life-expectancy', Chart::TYPE_COLUMN, $this->dataset, $sql);
    ...
    try
    {
        $Page = new v_charts_multiple_chartsPage("v_charts_multiple_charts", "charts_multiple_charts.php", GetCurrentUserPermissionsForPage("v_charts_multiple_charts"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_charts_multiple_charts"));
