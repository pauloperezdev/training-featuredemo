 ...
 */
    ...
    class v_charts_piePage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Charts.Pie');
            $this->SetMenuLabel('Pie Chart');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/charts_pie.html"));
        }
        ...
        {
            $chart = new Chart('pie-chart', Chart::TYPE_PIE, $this->dataset);
    ...
    try
    {
        $Page = new v_charts_piePage("v_charts_pie", "charts_pie.php", GetCurrentUserPermissionsForPage("v_charts_pie"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_charts_pie"));
