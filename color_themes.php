 ...
 */
    ...
    class v_color_themesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Fine-tuning & Tweaking.Color Themes');
            $this->SetMenuLabel('Color Themes');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/tweaking_color_themes.html"));
        }
        ...
        {
            return 'function changeColorTheme() {'. "\n" .
            '    var currentTheme = (getCookie(\'demo_theme\') !== null) ? getCookie(\'demo_theme\') : getCookie(\'theme\');'. "\n" .
            '    var currentThemeElementIndex = -1;'. "\n" .
            '    var $themeElements = $(\'#themes\').find(\'a\');'. "\n" .
            '    var themeCount = $themeElements.length;'. "\n" .
            '    if (currentTheme) {'. "\n" .
            '        $themeElements.each( function(index) {'. "\n" .
            '            if ($(this).text() === currentTheme) {'. "\n" .
            '                currentThemeElementIndex = index;'. "\n" .
            '            }'. "\n" .
            '        });'. "\n" .
            '    }'. "\n" .
            '    var nextTheme = \'\';'. "\n" .
            '    if (currentThemeElementIndex === -1) {'. "\n" .
            '        nextTheme = $($themeElements.get(1)).text();'. "\n" .
            '    } else if (currentThemeElementIndex < themeCount - 1) {'. "\n" .
            '        nextTheme = $($themeElements.get(currentThemeElementIndex + 1)).text();'. "\n" .
            '    } else {'. "\n" .
            '        nextTheme = $($themeElements.get(0)).text();'. "\n" .
            '    }'. "\n" .
            ''. "\n" .
            '    setCookie(\'demo_theme\', nextTheme, 360);'. "\n" .
            '    location.reload();'. "\n" .
            '}'. "\n" .
            ''. "\n" .
            'setTimeout('. "\n" .
    ...
    try
    {
        $Page = new v_color_themesPage("v_color_themes", "color_themes.php", GetCurrentUserPermissionsForPage("v_color_themes"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_color_themes"));
