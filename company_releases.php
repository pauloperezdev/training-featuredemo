 ...
 */
    ...
    class company_releasesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Company Releases');
            $this->SetMenuLabel('Company Releases');
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('link_edit');
    ...
    try
    {
        $Page = new company_releasesPage("company_releases", "company_releases.php", GetCurrentUserPermissionsForPage("company_releases"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("company_releases"));
