define([
    ...
    function attachHint(editor) {
        var hintContainer = editor.closest('.row').find('.js-hint');
        if (hintContainer) {
            hintContainer.popover({
                placement: editor.data('hint-placement') || 'top',
                trigger: 'hover',
                container: 'body',
                html: true,
                content: hintContainer.attr('data-hint')
            });
        }
        hintContainer = editor.closest('.col-input').prev().find('.js-hint');
        if (hintContainer) {
            hintContainer.popover({
                placement: editor.data('hint-placement') || 'top',
                trigger: 'hover',
