 ...
 */
    ...
    class country_cityPage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_country_city_CountryCode_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('CountryCode', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_country_city_CountryCode_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Country Code', 'CountryCode', 'CountryCode_Name', 'edit_country_city_CountryCode_search', $editor, $this->dataset, $lookupDataset, 'Code', 'Name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Country Code', 'CountryCode', 'CountryCode_Name', 'multi_edit_country_city_CountryCode_search', $editor, $this->dataset, $lookupDataset, 'Code', 'Name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Country Code', 'CountryCode', 'CountryCode_Name', 'insert_country_city_CountryCode_search', $editor, $this->dataset, $lookupDataset, 'Code', 'Name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_country_city_CountryCode_search', 'Code', 'Name', null, 20);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_country_city_CountryCode_search', 'Code', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_country_city_CountryCode_search', 'Code', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_country_city_CountryCode_search', 'Code', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class country_country_languagePage extends DetailPage
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Country Language');
            $this->SetMenuLabel('Country Language');
            ...
            $this->dataset->addFields(
                array(
                    new StringField('CountryCode', true, true),
                    new StringField('Language', true, true),
                    new StringField('IsOfficial', true),
                    new IntegerField('Percentage', true)
                )
            );
            $this->dataset->AddLookupField('CountryCode', 'country', new StringField('Code'), new StringField('Name', false, false, false, false, 'CountryCode_Name', 'CountryCode_Name_country'), 'CountryCode_Name_country');
        }
        ...
        protected function getFiltersColumns()
        {
            return array(
                new FilterColumn($this->dataset, 'CountryCode', 'CountryCode_Name', 'Country Code'),
                new FilterColumn($this->dataset, 'Language', 'Language', 'Language'),
                new FilterColumn($this->dataset, 'IsOfficial', 'IsOfficial', 'Is Official'),
                new FilterColumn($this->dataset, 'Percentage', 'Percentage', 'Percentage')
            );
        }
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ...
                ->addColumn($columns['IsOfficial'])
                ->addColumn($columns['Percentage']);
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_country_country_language_CountryCode_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('CountryCode', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_country_country_language_CountryCode_search');
            ...
            $main_editor = new ComboBox('isofficial_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $main_editor->addChoice('T', 'T');
            $main_editor->addChoice('F', 'F');
            $main_editor->SetAllowNullValue(false);
            
            $multi_value_select_editor = new MultiValueSelect('IsOfficial');
            $multi_value_select_editor->setChoices($main_editor->getChoices());
            
            $text_editor = new TextEdit('IsOfficial');
            ...
            $main_editor = new TextEdit('percentage_edit');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('Language', 'Language', 'Language', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            //
            // View column for IsOfficial field
            //
            $column = new TextViewColumn('IsOfficial', 'IsOfficial', 'Is Official', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            //
            // View column for Percentage field
            //
            $column = new NumberViewColumn('Percentage', 'Percentage', 'Percentage', $this->dataset);
            $column->SetOrderable(true);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Country Code', 'CountryCode', 'CountryCode_Name', 'edit_country_country_language_CountryCode_search', $editor, $this->dataset, $lookupDataset, 'Code', 'Name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            $editor = new TextEdit('language_edit');
            ...
            //
            // Edit column for IsOfficial field
            //
            $editor = new ComboBox('isofficial_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $editor->addChoice('T', 'T');
            $editor->addChoice('F', 'F');
            $editColumn = new CustomEditColumn('Is Official', 'IsOfficial', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for Percentage field
            //
            $editor = new TextEdit('percentage_edit');
            $editColumn = new CustomEditColumn('Percentage', 'Percentage', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Country Code', 'CountryCode', 'CountryCode_Name', 'insert_country_country_language_CountryCode_search', $editor, $this->dataset, $lookupDataset, 'Code', 'Name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_country_country_language_CountryCode_search', 'Code', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_country_country_language_CountryCode_search', 'Code', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_country_country_language_CountryCode_search', 'Code', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class country_employeesPage extends DetailPage
    {
        protected function DoBeforeCreate()
        {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_country_employees_country_code_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('country_code', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_country_employees_country_code_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_country_employees_city_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('city_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_country_employees_city_id_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Country Code', 'country_code', 'country_code_Name', 'edit_country_employees_country_code_search', $editor, $this->dataset, $lookupDataset, 'Code', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('City Id', 'city_id', 'city_id_Name', 'edit_country_employees_city_id_search', $editor, $this->dataset, $lookupDataset, 'ID', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Country Code', 'country_code', 'country_code_Name', 'multi_edit_country_employees_country_code_search', $editor, $this->dataset, $lookupDataset, 'Code', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('City Id', 'city_id', 'city_id_Name', 'multi_edit_country_employees_city_id_search', $editor, $this->dataset, $lookupDataset, 'ID', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        }
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Country Code', 'country_code', 'country_code_Name', 'insert_country_employees_country_code_search', $editor, $this->dataset, $lookupDataset, 'Code', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('City Id', 'city_id', 'city_id_Name', 'insert_country_employees_city_id_search', $editor, $this->dataset, $lookupDataset, 'ID', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            $grid->SetShowAddButton(true && $this->GetSecurityInfo()->HasAddGrant());
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_country_employees_country_code_search', 'Code', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_country_employees_city_id_search', 'ID', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_country_employees_country_code_search', 'Code', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_country_employees_city_id_search', 'ID', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_country_employees_country_code_search', 'Code', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_country_employees_city_id_search', 'ID', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_country_employees_country_code_search', 'Code', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_country_employees_city_id_search', 'ID', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class countryPage extends Page
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_country_Capital_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Capital', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_country_Capital_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('country.city')->HasViewGrant() && $withDetails)
            {
            //
            // View column for country_city detail
            //
            $column = new DetailColumn(array('Code'), 'country.city', 'country_city_handler', $this->dataset, 'City');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            
            if (GetCurrentUserPermissionsForPage('country.country_language')->HasViewGrant() && $withDetails)
            {
            //
            // View column for country_country_language detail
            //
            $column = new DetailColumn(array('Code'), 'country.country_language', 'country_country_language_handler', $this->dataset, 'Country Language');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            
            if (GetCurrentUserPermissionsForPage('country.employees')->HasViewGrant() && $withDetails)
            {
            //
            // View column for country_employees detail
            //
            $column = new DetailColumn(array('Code'), 'country.employees', 'country_employees_handler', $this->dataset, 'Employees');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Capital', 'Capital', 'Capital_Name', 'edit_country_Capital_search', $editor, $this->dataset, $lookupDataset, 'ID', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Capital', 'Capital', 'Capital_Name', 'multi_edit_country_Capital_search', $editor, $this->dataset, $lookupDataset, 'ID', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Capital', 'Capital', 'Capital_Name', 'insert_country_Capital_search', $editor, $this->dataset, $lookupDataset, 'ID', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            $detailPage = new country_cityPage('country_city', $this, array('CountryCode'), array('Code'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('country.city'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('country.city'));
            $detailPage->SetHttpHandlerName('country_city_handler');
            $handler = new PageHTTPHandler('country_city_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            
            $detailPage = new country_country_languagePage('country_country_language', $this, array('CountryCode'), array('Code'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('country.country_language'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('country.country_language'));
            $detailPage->SetHttpHandlerName('country_country_language_handler');
            $handler = new PageHTTPHandler('country_country_language_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            
            $detailPage = new country_employeesPage('country_employees', $this, array('country_code'), array('Code'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('country.employees'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('country.employees'));
            $detailPage->SetHttpHandlerName('country_employees_handler');
            $handler = new PageHTTPHandler('country_employees_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_country_Capital_search', 'ID', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_country_Capital_search', 'ID', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_country_Capital_search', 'ID', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_country_Capital_search', 'ID', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new countryPage("country", "country.php", GetCurrentUserPermissionsForPage("country"), 'UTF-8');
