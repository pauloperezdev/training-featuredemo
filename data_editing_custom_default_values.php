 ...
 */
    ...
    class v_data_editing_custom_default_valuesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Data Input Forms.Custom Default Values');
            $this->SetMenuLabel('Custom Default Values');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_editing_custom_default_values`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_editing_custom_default_values.html"));
            $this->setDetailedDescription(extractMethodCode($this, "doCustomDefaultValues"));
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_v_data_editing_custom_default_values_assignee_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('assignee', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_v_data_editing_custom_default_values_assignee_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Assignee', 'assignee', 'assignee_name', 'edit_v_data_editing_custom_default_values_assignee_search', $editor, $this->dataset, $lookupDataset, 'id', 'name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Assignee', 'assignee', 'assignee_name', 'multi_edit_v_data_editing_custom_default_values_assignee_search', $editor, $this->dataset, $lookupDataset, 'id', 'name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Assignee', 'assignee', 'assignee_name', 'insert_v_data_editing_custom_default_values_assignee_search', $editor, $this->dataset, $lookupDataset, 'id', 'name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function CreateGrid()
        {
            ...
            $this->SetInsertFormTitle('Add new task');
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_v_data_editing_custom_default_values_assignee_search', 'id', 'name', null, 20);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_v_data_editing_custom_default_values_assignee_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_v_data_editing_custom_default_values_assignee_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_v_data_editing_custom_default_values_assignee_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
        ...
        {
            $taskDeadline = SMDateTime::now();
            $taskDeadline->addDays(14);
            $values['deadline'] = $taskDeadline;  
            $handled = true;
        }
    ...
    try
    {
        $Page = new v_data_editing_custom_default_valuesPage("v_data_editing_custom_default_values", "data_editing_custom_default_values.php", GetCurrentUserPermissionsForPage("v_data_editing_custom_default_values"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_editing_custom_default_values"));
