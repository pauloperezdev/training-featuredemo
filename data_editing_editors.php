 ...
 */
    ...
    class v_data_editing_editorsPage extends Page
    {
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'CountryCode = \'GBR\''));
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_v_data_editing_editors_autocomplete_search', 'ID', 'Name', null, 20);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'CountryCode = \'GBR\''));
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_v_data_editing_editors_autocomplete_search', 'ID', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_v_data_editing_editors_multi_level_search', 'ID', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'CountryCode = \'GBR\''));
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_v_data_editing_editors_autocomplete_search', 'ID', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'CountryCode = \'GBR\''));
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_v_data_editing_editors_autocomplete_search', 'ID', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
