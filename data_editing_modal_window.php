 ...
 */
    ...
    class v_data_editing_modal_windowPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Data Input Forms.Modal Window');
            $this->SetMenuLabel('Modal Window');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_editing_modal_window`');
            ...
            $this->dataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'v_data_editing_modal_window.Population > 8000000'));
        }
    
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_editing_modal_window.html"));
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_v_data_editing_modal_window_countrycode_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('countrycode', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_v_data_editing_modal_window_countrycode_search');
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_v_data_editing_modal_window_countrycode_search', 'Code', 'Name', null, 20);
    ...
    try
    {
        $Page = new v_data_editing_modal_windowPage("v_data_editing_modal_window", "data_editing_modal_window.php", GetCurrentUserPermissionsForPage("v_data_editing_modal_window"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_editing_modal_window"));
