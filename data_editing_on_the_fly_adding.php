 ...
 */
    ...
    class city_CountryCodeNestedPage extends NestedFormPage
    {
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            //
            $editor = new ImageUploader('flag_edit');
            $editor->setInlineStyles('max-height: 200px;');
            $editor->SetShowImage(true);
            $editor->setAcceptableFileTypes('image/*');
            $editColumn = new UploadFileToFolderColumn('Flag', 'flag', $editor, $this->dataset, false, false, 'external_data/images/flags', '%original_file_name%', $this->OnFileUpload, true);
    ...
    class cityPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Data Input Forms.On-the-Fly Adding');
            $this->SetMenuLabel('On-the-Fly Adding');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_editing_on_the_fly_adding.html"));
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn->setNestedInsertFormLink(
                $this->GetHandlerLink(city_CountryCodeNestedPage::getNestedInsertHandlerName())
            );
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            new city_CountryCodeNestedPage($this, GetCurrentUserPermissionsForPage('city.CountryCode'));
        }
    ...
    try
    {
        $Page = new cityPage("city", "data_editing_on_the_fly_adding.php", GetCurrentUserPermissionsForPage("city"), 'UTF-8');
