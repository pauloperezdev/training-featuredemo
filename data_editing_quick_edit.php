 ...
 */
    ...
    class v_data_editing_quick_editPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Data Input Forms.Quick Edit');
            $this->SetMenuLabel('Quick Edit');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_editing_quick_edit`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_editing_quick_edit.html"));
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_v_data_editing_quick_edit_countrycode_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('countrycode', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_v_data_editing_quick_edit_countrycode_search');
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_v_data_editing_quick_edit_countrycode_search', 'Code', 'Name', null, 20);
    ...
    try
    {
        $Page = new v_data_editing_quick_editPage("v_data_editing_quick_edit", "data_editing_quick_edit.php", GetCurrentUserPermissionsForPage("v_data_editing_quick_edit"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_editing_quick_edit"));
