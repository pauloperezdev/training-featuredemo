 ...
 */
    ...
    class v_data_editing_validationPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Data Input Forms.Validation');
            $this->SetMenuLabel('Validation');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_editing_validation`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_editing_validation.html"));
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $validator = new CustomRegExpValidator('[A-Z][a-z]+', StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RegExpValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
        ...
        protected function setClientSideEvents(Grid $grid) {
            $grid->SetInsertClientValidationScript('if (fieldValues.name == fieldValues.lastname) {
               errorInfo.SetMessage(\'Last name should not be equal to name.\');
               return false;
            }');
            
            $grid->SetEditClientValidationScript('if (fieldValues.name == fieldValues.lastname) {
               errorInfo.SetMessage(\'Last name should not be equal to name.\');
               return false;
            }');
        }
    ...
    try
    {
        $Page = new v_data_editing_validationPage("v_data_editing_validation", "data_editing_validation.php", GetCurrentUserPermissionsForPage("v_data_editing_validation"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_editing_validation"));
