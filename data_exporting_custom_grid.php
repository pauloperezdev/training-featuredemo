 ...
 */
    ...
    class v_data_exporting_custom_templatePage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Exporting & Printing.Custom Grid');
            $this->SetMenuLabel('Custom Grid');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_exporting_custom_template`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_exporting_custom_template.html"));
        ...
        {
            if ($part == PagePart::Grid) {
                if ($mode == PageMode::ExportPdf) {
                   $result = 'custom_export_pdf_list.tpl';
                } elseif ($mode == PageMode::PrintAll) {
    ...
    try
    {
        $Page = new v_data_exporting_custom_templatePage("v_data_exporting_custom_template", "data_exporting_custom_grid.php", GetCurrentUserPermissionsForPage("v_data_exporting_custom_template"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_exporting_custom_template"));
