 ...
 */
    ...
    class invoice_header_invoice_detailPage extends DetailPage
    {
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('product_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_invoice_header_invoice_detail_product_id_search', 'id', 'product_name', null, 20);
            ...
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_invoice_header_invoice_detail_invoice_header_id_search', 'id', 'invoice_date', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('product_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_invoice_header_invoice_detail_product_id_search', 'id', 'product_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('product_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_invoice_header_invoice_detail_product_id_search', 'id', 'product_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('product_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_invoice_header_invoice_detail_product_id_search', 'id', 'product_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class invoice_headerPage extends Page
    {
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('customer_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_invoice_header_customer_id_search', 'id', 'customer_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('customer_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_invoice_header_customer_id_search', 'id', 'customer_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('customer_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_invoice_header_customer_id_search', 'id', 'customer_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('customer_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_invoice_header_customer_id_search', 'id', 'customer_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
