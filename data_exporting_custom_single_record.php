 ...
 */
    ...
    class invoice_header_invoice_detailPage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new DynamicCombobox('invoice_header_id_edit', $this->CreateLinkBuilder());
            $main_editor->setAllowClear(true);
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_invoice_header_invoice_detail_invoice_header_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('invoice_header_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_invoice_header_invoice_detail_invoice_header_id_search');
            
            $filterBuilder->addColumn(
                $columns['invoice_header_id'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_invoice_header_invoice_detail_product_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('product_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_invoice_header_invoice_detail_product_id_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Product', 'product_id', 'product_id_product_name', 'edit_invoice_header_invoice_detail_product_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'product_name', '');
            $editColumn->setNestedInsertFormLink(
                $this->GetHandlerLink(invoice_header_invoice_detail_product_idNestedPage::getNestedInsertHandlerName())
            );
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('product_name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Product', 'product_id', 'product_id_product_name', 'multi_edit_invoice_header_invoice_detail_product_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'product_name', '');
            $editColumn->setNestedInsertFormLink(
                $this->GetHandlerLink(invoice_header_invoice_detail_product_idNestedPage::getNestedInsertHandlerName())
            );
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('product_name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Product', 'product_id', 'product_id_product_name', 'insert_invoice_header_invoice_detail_product_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'product_name', '');
            $editColumn->setNestedInsertFormLink(
                $this->GetHandlerLink(invoice_header_invoice_detail_product_idNestedPage::getNestedInsertHandlerName())
            );
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
        ...
        protected function CreateGrid()
        {
            ...
            $result->SetTotal('line_total', new CustomAggregate('SUM(quantity*unit_price)', 'Total'));
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('product_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_invoice_header_invoice_detail_product_id_search', 'id', 'product_name', null, 20);
            ...
            $lookupDataset->setOrderByField('invoice_date', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_invoice_header_invoice_detail_invoice_header_id_search', 'id', 'invoice_date', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('product_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_invoice_header_invoice_detail_product_id_search', 'id', 'product_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('product_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_invoice_header_invoice_detail_product_id_search', 'id', 'product_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('product_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_invoice_header_invoice_detail_product_id_search', 'id', 'product_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class invoice_header_invoice_detail_product_idNestedPage extends NestedFormPage
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
    ...
    class invoice_headerPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Exporting & Printing.Custom Single Record');
            $this->SetMenuLabel('Custom Single Record');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_exporting_custom_single_record.html"));
            $this->setDetailedDescription(
              extractMethodCode($this, 'doGetCustomTemplate') .
              '<div id="sales-invoice-pdf" style="display: none;">' .
              extractTemplateFileCode('components/templates/custom_templates/sales_invoice_pdf.tpl') .
              '</div>' .
              '<div id="sales-invoice" style="display: none;">' .
              extractTemplateFileCode('components/templates/custom_templates/sales_invoice.tpl') .
              '</div>' .
              '<div id="sales-invoice-print" style="display: none;">' .
              extractTemplateFileCode('components/templates/custom_templates/sales_invoice_print.tpl') .
              '</div>'
            );
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_invoice_header_customer_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('customer_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_invoice_header_customer_id_search');
            
            $text_editor = new TextEdit('customer_id');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('invoice_header.invoice_detail')->HasViewGrant() && $withDetails)
            {
            //
            // View column for invoice_header_invoice_detail detail
            //
            $column = new DetailColumn(array('id'), 'invoice_header.invoice_detail', 'invoice_header_invoice_detail_handler', $this->dataset, 'Invoice Detail');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Customer', 'customer_id', 'customer_id_customer_name', 'edit_invoice_header_customer_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'customer_name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('customer_name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Customer', 'customer_id', 'customer_id_customer_name', 'multi_edit_invoice_header_customer_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'customer_name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('customer_name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Customer', 'customer_id', 'customer_id_customer_name', 'insert_invoice_header_customer_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'customer_name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            $detailPage = new invoice_header_invoice_detailPage('invoice_header_invoice_detail', $this, array('invoice_header_id'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('invoice_header.invoice_detail'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('invoice_header.invoice_detail'));
            $detailPage->SetHttpHandlerName('invoice_header_invoice_detail_handler');
            $handler = new PageHTTPHandler('invoice_header_invoice_detail_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('customer_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_invoice_header_customer_id_search', 'id', 'customer_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('customer_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_invoice_header_customer_id_search', 'id', 'customer_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('customer_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_invoice_header_customer_id_search', 'id', 'customer_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('customer_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_invoice_header_customer_id_search', 'id', 'customer_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            
            
            
            new invoice_header_invoice_detail_product_idNestedPage($this, GetCurrentUserPermissionsForPage('invoice_header.invoice_detail.product_id'));
        }
    ...
    try
    {
        $Page = new invoice_headerPage("invoice_header", "data_exporting_custom_single_record.php", GetCurrentUserPermissionsForPage("invoice_header"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("invoice_header"));
