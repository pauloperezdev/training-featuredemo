 ...
 */
    ...
    class v_data_exporting_export_optionsPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Exporting & Printing.Export Options');
            $this->SetMenuLabel('Export Options');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_exporting_export_options`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_exporting_export_options.html"));
            $this->setDetailedDescription(extractMethodCode($this, 'doGetCustomExportOptions'));
        }
        ...
        protected function doGetCustomExportOptions(Page $page, $exportType, $rowData, &$options)
        {
            if ($exportType === 'pdf') {
              ...
              $options['header'] = 'Export date: {DATE Y-m-d}'; 
              $options['footer'] = '{PAGENO}';
              $options['margin-top'] = 12;   
            } elseif ($exportType === 'xls') {
              $options['engine'] = 'phpexcel';
            }
            
            $filenamePrefix = $rowData ? $rowData['code'] : 'list';
            $options['filename'] = $filenamePrefix . '_country.' . $exportType;
        }
    ...
    try
    {
        $Page = new v_data_exporting_export_optionsPage("v_data_exporting_export_options", "data_exporting_export_options.php", GetCurrentUserPermissionsForPage("v_data_exporting_export_options"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_exporting_export_options"));
