 ...
 */
    ...
    class v_data_exporting_export_record_from_gridPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Exporting & Printing.Single Record');
            $this->SetMenuLabel('Single Record');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_exporting_export_record_from_grid`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_exporting_single_record.html"));
        }
    ...
    try
    {
        $Page = new v_data_exporting_export_record_from_gridPage("v_data_exporting_export_record_from_grid", "data_exporting_single_record.php", GetCurrentUserPermissionsForPage("v_data_exporting_export_record_from_grid"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_exporting_export_record_from_grid"));
