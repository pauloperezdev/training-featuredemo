 ...
 */
    ...
    class v_data_exporting_user_defined_stylesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Exporting & Printing.User Defined Styles');
            $this->SetMenuLabel('User Defined Styles');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_exporting_user_defined_styles`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_exporting_user_defined_styles.html"));
            $this->setDetailedDescription(
              '<br>' .
              '<div id="user-defined-styles-pdf">' .
                extractLessCode('Exporting & Printing.User Defined Styles', 'user_pdf') . 
              '</div>' .
              '<div id="user-defined-styles-print">' .
                extractLessCode('Exporting & Printing.User Defined Styles', 'user_print') .
              '</div>'
            );
        }
    ...
    try
    {
        $Page = new v_data_exporting_user_defined_stylesPage("v_data_exporting_user_defined_styles", "data_exporting_user_defined_styles.php", GetCurrentUserPermissionsForPage("v_data_exporting_user_defined_styles"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_exporting_user_defined_styles"));
