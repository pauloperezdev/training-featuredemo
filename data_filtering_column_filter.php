 ...
 */
    ...
    class moviesPage extends Page
    {
        ...
        {
            $this->SetTitle('Filtering.Column Filter');
            $this->SetMenuLabel('Column Filter');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_filtering_column_filter.html"));
            $this->setDetailedDescription(extractMethodCode($this, "doPrepareColumnFilter"));
        }
        ...
        {
            $columnFilter
                ->setOptionsFor('runtime')
                ->setOptionsFor('release_date')
                ->setOptionsFor('rating')
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_movies_original_language_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('original_language_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_movies_original_language_id_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_movies_genre_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('genre_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_movies_genre_id_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new UploadFileToFolderColumn('Poster', 'poster', $editor, $this->dataset, false, false, 'images/posters/', '%original_file_name%', $this->OnFileUpload, false);
        ...
        protected function CreateGrid()
        {
            ...
            $defaultSortedColumns[] = new SortColumn('rating', 'DESC');
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_movies_original_language_id_search', 'id', 'name', null, 20);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_movies_genre_id_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new moviesPage("movies", "data_filtering_column_filter.php", GetCurrentUserPermissionsForPage("movies"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("movies"));
