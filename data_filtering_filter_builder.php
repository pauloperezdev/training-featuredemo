 ...
 */
    ...
    class movies02Page extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Filtering.Filter Builder');
            $this->SetMenuLabel('Filter Builder');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_filtering_filter_builder.html"));
            $this->setDetailedDescription(extractMethodCode($this, "doPrepareFilterBuilder"));
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('poster_edit');
            $main_editor->SetMaxLength(255);
            ...
            $main_editor->SetHandlerName('filter_builder_movies02_original_language_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('original_language_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_movies02_original_language_id_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_movies02_genre_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('genre_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_movies02_genre_id_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('poster_edit');
            $editor->SetMaxLength(255);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_movies02_original_language_id_search', 'id', 'name', null, 20);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_movies02_genre_id_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
        ...
        protected function doPrepareFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            $rootGroup = new FilterGroup(FilterGroupOperator::OPERATOR_AND,
                array(
                    new FilterCondition($columns['rating'], FilterConditionOperator::IS_BETWEEN, array(5, 7)),
                    new FilterCondition($columns['genre_id'], FilterConditionOperator::EQUALS, array(14), array('Fantasy'))
                )
            );
    ...
    try
    {
        $Page = new movies02Page("movies02", "data_filtering_filter_builder.php", GetCurrentUserPermissionsForPage("movies02"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("movies02"));
