 ...
 */
    ...
    class v_data_filtering_quick_filterPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Filtering.Quick Filter');
            $this->SetMenuLabel('Quick Filter');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_filtering_quick_filter`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_filtering_quick_filter.html"));
        }
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new NumberViewColumn('indepyear', 'indepyear', 'Independence Year', $this->dataset);
            $column->SetOrderable(true);
        ...
        protected function CreateGrid()
        {
            ...
            $defaultSortedColumns[] = new SortColumn('population', 'DESC');
    ...
    try
    {
        $Page = new v_data_filtering_quick_filterPage("v_data_filtering_quick_filter", "data_filtering_quick_filter.php", GetCurrentUserPermissionsForPage("v_data_filtering_quick_filter"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_filtering_quick_filter"));
