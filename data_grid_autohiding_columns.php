 ...
 */
    ...
    class v_data_grid_autohiding_columnsPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Data Grid.Autohiding Columns');
            $this->SetMenuLabel('Autohiding Columns');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_grid_autohiding_columns`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_grid_autohiding_columns.html"));
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new ComboBox('capital_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $main_editor->SetAllowNullValue(false);
            
            $multi_value_select_editor = new MultiValueSelect('Capital');
            $multi_value_select_editor->setChoices($main_editor->getChoices());
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            //
            $column = new TextViewColumn('LocalName', 'LocalName', 'LocalName', $this->dataset);
            $column->SetOrderable(true);
            $grid->AddSingleRecordViewColumn($column);
            ...
            //
            $column = new TextViewColumn('GovernmentForm', 'GovernmentForm', 'GovernmentForm', $this->dataset);
            $column->SetOrderable(true);
            $grid->AddSingleRecordViewColumn($column);
            ...
            //
            $column = new TextViewColumn('HeadOfState', 'HeadOfState', 'HeadOfState', $this->dataset);
            $column->SetOrderable(true);
            $grid->AddSingleRecordViewColumn($column);
            ...
            //
            $column = new TextViewColumn('Capital', 'Capital', 'Capital', $this->dataset);
            $column->SetOrderable(true);
            $grid->AddSingleRecordViewColumn($column);
    ...
    try
    {
        $Page = new v_data_grid_autohiding_columnsPage("v_data_grid_autohiding_columns", "data_grid_autohiding_columns.php", GetCurrentUserPermissionsForPage("v_data_grid_autohiding_columns"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_grid_autohiding_columns"));
