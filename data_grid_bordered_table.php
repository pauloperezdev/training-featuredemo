 ...
 */
    ...
    class v_data_grid_bordered_tablePage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Grid Options.Bordered Table');
            $this->SetMenuLabel('Bordered Table');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_grid_bordered_table`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_grid_bordered_table.html"));
        }
    ...
    try
    {
        $Page = new v_data_grid_bordered_tablePage("v_data_grid_bordered_table", "data_grid_bordered_table.php", GetCurrentUserPermissionsForPage("v_data_grid_bordered_table"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_grid_bordered_table"));
