 ...
 */
    ...
    class v_data_grid_card_viewPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Data Grid.Card View');
            $this->SetMenuLabel('Card View');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_grid_card_view`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_grid_card_view.html"));
        }
    ...
    try
    {
        $Page = new v_data_grid_card_viewPage("v_data_grid_card_view", "data_grid_card_view.php", GetCurrentUserPermissionsForPage("v_data_grid_card_view"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_grid_card_view"));
