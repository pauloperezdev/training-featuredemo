 ...
 */
    ...
    class movies01Page extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Data Grid.Column Grouping');
            $this->SetMenuLabel('Column Grouping');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_grid_column_grouping.html"));
            $this->setDetailedDescription(extractMethodCode($this, "doGetCustomColumnGroup"));
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_movies01_original_language_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('original_language_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_movies01_original_language_id_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_movies01_genre_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('genre_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_movies01_genre_id_search');
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_movies01_original_language_id_search', 'id', 'name', null, 20);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_movies01_genre_id_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new movies01Page("movies01", "data_grid_column_grouping.php", GetCurrentUserPermissionsForPage("movies01"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("movies01"));
