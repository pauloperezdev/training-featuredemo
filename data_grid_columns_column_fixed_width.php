 ...
 */
    ...
    class v_data_grid_columns_column_fixed_widthPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Grid Columns.Column Fixed Width');
            $this->SetMenuLabel('Column Fixed Width');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_grid_columns_column_fixed_width`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_grid_columns_column_fixed_width.html"));
        }
    ...
    try
    {
        $Page = new v_data_grid_columns_column_fixed_widthPage("v_data_grid_columns_column_fixed_width", "data_grid_columns_column_fixed_width.php", GetCurrentUserPermissionsForPage("v_data_grid_columns_column_fixed_width"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_grid_columns_column_fixed_width"));
