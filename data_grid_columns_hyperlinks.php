 ...
 */
    ...
    class v_data_grid_columns_hyperlinksPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Grid Columns.Hyperlinks');
            $this->SetMenuLabel('Hyperlinks');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_grid_columns_hyperlinks`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_grid_columns_hyperlinks.html"));
        }
    ...
    try
    {
        $Page = new v_data_grid_columns_hyperlinksPage("v_data_grid_columns_hyperlinks", "data_grid_columns_hyperlinks.php", GetCurrentUserPermissionsForPage("v_data_grid_columns_hyperlinks"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_grid_columns_hyperlinks"));
