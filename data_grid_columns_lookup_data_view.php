 ...
 */
    ...
    class v_data_grid_columns_lookup_data_viewPage extends Page
    {
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_v_data_grid_columns_lookup_data_view_CountryCode_search', 'Code', 'Name', null, 20);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_v_data_grid_columns_lookup_data_view_CountryCode_search', 'Code', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_v_data_grid_columns_lookup_data_view_CountryCode_search', 'Code', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_v_data_grid_columns_lookup_data_view_CountryCode_search', 'Code', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
