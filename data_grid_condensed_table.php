 ...
 */
    ...
    class v_data_grid_condensed_tablePage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Grid Options.Condensed Table');
            $this->SetMenuLabel('Condensed Table');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_grid_condensed_table`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_grid_condensed_table.html"));
        }
    ...
    try
    {
        $Page = new v_data_grid_condensed_tablePage("v_data_grid_condensed_table", "data_grid_condensed_table.php", GetCurrentUserPermissionsForPage("v_data_grid_condensed_table"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_grid_condensed_table"));
