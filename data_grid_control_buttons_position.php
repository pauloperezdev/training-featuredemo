 ...
 */
    ...
    class v_data_grid_optionsPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Grid Options.Control Buttons Position');
            $this->SetMenuLabel('Control Buttons Position');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_grid_control_buttons_position.html"));
        }
    ...
    try
    {
        $Page = new v_data_grid_optionsPage("v_data_grid_options", "data_grid_control_buttons_position.php", GetCurrentUserPermissionsForPage("v_data_grid_options"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_grid_options"));
