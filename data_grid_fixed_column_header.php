 ...
 */
    ...
    class v_data_grid_fixed_headerPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Grid Options.Fixed Column Header');
            $this->SetMenuLabel('Fixed Column Header');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_grid_fixed_header`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_grid_fixed_column_header.html"));
        }
    ...
    try
    {
        $Page = new v_data_grid_fixed_headerPage("v_data_grid_fixed_header", "data_grid_fixed_column_header.php", GetCurrentUserPermissionsForPage("v_data_grid_fixed_header"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_grid_fixed_header"));
