 ...
 */
    ...
    class v_data_grid_fixed_grid_widthPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Grid Options.Fixed Grid Width');
            $this->SetMenuLabel('Fixed Grid Width');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_grid_fixed_grid_width`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_grid_fixed_grid_width.html"));
        }
    ...
    try
    {
        $Page = new v_data_grid_fixed_grid_widthPage("v_data_grid_fixed_grid_width", "data_grid_fixed_grid_width.php", GetCurrentUserPermissionsForPage("v_data_grid_fixed_grid_width"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_grid_fixed_grid_width"));
