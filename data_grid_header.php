 ...
 */
    ...
    class v_data_grid_headerPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Data Grid.Grid Header');
            $this->SetMenuLabel('Grid Header');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_grid_header.html"));
        }
    ...
    try
    {
        $Page = new v_data_grid_headerPage("v_data_grid_header", "data_grid_header.php", GetCurrentUserPermissionsForPage("v_data_grid_header"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_grid_header"));
