 ...
 */
    ...
    class v_data_grid_line_numbersPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Grid Options.Line Numbers');
            $this->SetMenuLabel('Line Numbers');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_grid_line_numbers`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_grid_line_numbers.html"));
        }
    ...
    try
    {
        $Page = new v_data_grid_line_numbersPage("v_data_grid_line_numbers", "data_grid_line_numbers.php", GetCurrentUserPermissionsForPage("v_data_grid_line_numbers"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_grid_line_numbers"));
