 ...
 */
    ...
    class v_data_grid_rssPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Data Grid.RSS');
            $this->SetMenuLabel('RSS');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_grid_rss.html"));
        }
        ...
        {
            $result = new DatasetRssGenerator($this->dataset, 'SQL Maestro Releases','http://demo.sqlmaestro.com/feature_demo/data_grid_rss.php','What is an RSS feed and how can you use it','%title%','https://www.sqlmaestro.com/news/company/%link%/','%description%');
            $result->SetItemCount(30);
            $result->SetItemPublicationDateFieldName('release_date');
            return $result;
        }
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $column->SetOrderable(true);
            $column->setHrefTemplate('https://www.sqlmaestro.com/news/company/%link%');
    ...
    try
    {
        $Page = new v_data_grid_rssPage("v_data_grid_rss", "data_grid_rss.php", GetCurrentUserPermissionsForPage("v_data_grid_rss"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_grid_rss"));
