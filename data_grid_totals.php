 ...
 */
    ...
    class v_data_grid_totalsPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Data Grid.Totals');
            $this->SetMenuLabel('Totals');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_grid_totals.html"));
            $this->setDetailedDescription(extractMethodCode($this, 'doCustomRenderTotal'));
        }
        ...
        protected function CreateGrid()
        {
            ...
            $result->SetTotal('Name', PredefinedAggregate::$Count);
            $result->SetTotal('SurfaceArea', PredefinedAggregate::$Sum);
            $result->SetTotal('Population', PredefinedAggregate::$Min);
            $result->SetTotal('LifeExpectancy', PredefinedAggregate::$Max);
            $result->SetTotal('GNP', PredefinedAggregate::$Average);
        ...
        {
            if ($columnName == 'SurfaceArea') {
                $customText = 'Total area: ' . number_format($totalValue, 2) . ' km<sup>2</sup>';
                $handled = true;
            }
            
            if ($columnName == 'GNP') {
                $customText = 'Average GNP: $' . number_format($totalValue, 2);
                $handled = true;
            }
            
            if ($columnName == 'Name') {
                $customText = '<strong>' . $totalValue . ' countries' . '</strong>';
                $handled = true;
            }
        }
    ...
    try
    {
        $Page = new v_data_grid_totalsPage("v_data_grid_totals", "data_grid_totals.php", GetCurrentUserPermissionsForPage("v_data_grid_totals"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_grid_totals"));
