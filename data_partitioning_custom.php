 ...
 */
    ...
    class v_data_partitioning_customPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Partitioning.Custom');
            $this->SetMenuLabel('Custom');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_partitioning_custom`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_partitioning_custom.html"));
        }
        ...
        protected function CreatePageNavigator()
        {
            ...
            $partitionNavigator = new CustomPageNavigator('partition', $this, $this->GetDataset(), 'Country by alphabet', $result, 'partition');
        ...
        {
            $condition = "left(name, 1) = '$partitionKey'";
        }
    ...
    try
    {
        $Page = new v_data_partitioning_customPage("v_data_partitioning_custom", "data_partitioning_custom.php", GetCurrentUserPermissionsForPage("v_data_partitioning_custom"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_partitioning_custom"));
