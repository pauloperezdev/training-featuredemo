 ...
 */
    ...
    class v_data_partitioning_listPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Partitioning.List');
            $this->SetMenuLabel('List');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_partitioning_list`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_partitioning_list.html"));
        }
        ...
        protected function CreatePageNavigator()
        {
            ...
            $partitionNavigator = new CustomPageNavigator('partition', $this, $this->dataset, 'Continent', $result);
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'IndepYear', 'IndepYear', 'Independence Year'),
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('IndepYear', 'IndepYear', 'Independence Year', $this->dataset);
            $column->SetOrderable(true);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new CustomEditColumn('Independence Year', 'IndepYear', $editor, $this->dataset);
        ...
        private $partitions = array(1 => array('\'Europe\''), 2 => array('\'Asia\''), 3 => array('\'North America\''), 4 => array('\'South America\''), 5 => array('\'Africa\''), 6 => array('\'Oceania\''), 7 => array('\'Antarctica\''));
        
        function partition_GetPartitionsHandler(&$partitions)
        {
            $partitions[1] = 'Europe';
            $partitions[2] = 'Asia';
            $partitions[3] = 'North America';
            $partitions[4] = 'South America';
            $partitions[5] = 'Africa';
            $partitions[6] = 'Oceania';
            $partitions[7] = 'Antarctica';
        }
        ...
        function partition_GetPartitionConditionHandler($partitionName, &$condition)
        {
            ...
            if (isset($partitionName) && isset($this->partitions[$partitionName]))
                foreach ($this->partitions[$partitionName] as $value)
                    AddStr($condition, sprintf('(Continent = %s)', $value), ' OR ');
        }
    ...
    try
    {
        $Page = new v_data_partitioning_listPage("v_data_partitioning_list", "data_partitioning_list.php", GetCurrentUserPermissionsForPage("v_data_partitioning_list"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_partitioning_list"));
