 ...
 */
    ...
    class v_data_partitioning_rangePage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Partitioning.Range');
            $this->SetMenuLabel('Range');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_partitioning_range`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_partitioning_range.html"));
        }
        ...
        protected function CreatePageNavigator()
        {
            ...
            $partitionNavigator = new CustomPageNavigator('partition', $this, $this->dataset, 'Life Expectancy', $result);
        ...
        private $partitions = array(1 => array(null, '50'), 2 => array('50', '55'), 3 => array('55', '60'), 4 => array('60', '65'), 5 => array('65', '70'), 6 => array('70', '75'), 7 => array('75', '80'), 8 => array('80', null));
        
        function partition_GetPartitionsHandler(&$partitions)
        {
            $partitions[1] = 'Below 50 years';
            $partitions[2] = '50-55 years';
            $partitions[3] = '55-60 years';
            $partitions[4] = '60-65 years';
            $partitions[5] = '65-70 years';
            $partitions[6] = '70-75 years';
            $partitions[7] = '75-80 years';
            $partitions[8] = 'Above 80 years';
        }
        ...
        function partition_GetPartitionConditionHandler($partitionName, &$condition)
        {
            ...
            if (isset($partitionName) && isset($this->partitions[$partitionName]))
            {
                if (isset($this->partitions[$partitionName][0]))
                    AddStr($condition, sprintf('(LifeExpectancy > %s)', $this->partitions[$partitionName][0]), ' AND ');
                if (isset($this->partitions[$partitionName][1]))
                    AddStr($condition, sprintf('(LifeExpectancy <= %s)', $this->partitions[$partitionName][1]), ' AND ');
            }
        }
    ...
    try
    {
        $Page = new v_data_partitioning_rangePage("v_data_partitioning_range", "data_partitioning_range.php", GetCurrentUserPermissionsForPage("v_data_partitioning_range"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_partitioning_range"));
