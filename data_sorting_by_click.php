 ...
 */
    ...
    class v_data_sorting_by_clickPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Sorting.By Click');
            $this->SetMenuLabel('Sort By Click');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_sorting_by_click`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_sorting_by_click.html"));
        }
    ...
    try
    {
        $Page = new v_data_sorting_by_clickPage("v_data_sorting_by_click", "data_sorting_by_click.php", GetCurrentUserPermissionsForPage("v_data_sorting_by_click"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_sorting_by_click"));
