 ...
 */
    ...
    class v_data_sorting_by_dialogPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Sorting.By Dialog');
            $this->SetMenuLabel('Sort By Dialog');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_sorting_by_dialog`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_sorting_by_dialog.html"));
        }
    ...
    try
    {
        $Page = new v_data_sorting_by_dialogPage("v_data_sorting_by_dialog", "data_sorting_by_dialog.php", GetCurrentUserPermissionsForPage("v_data_sorting_by_dialog"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_sorting_by_dialog"));
