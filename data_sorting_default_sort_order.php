 ...
 */
    ...
    class v_data_sorting_initial_orderPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Sorting.Default Sort Order');
            $this->SetMenuLabel('Default Sort Order');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_data_sorting_initial_order`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_sorting_default_sort_order.html"));
        }
        ...
        protected function CreateGrid()
        {
            ...
            $defaultSortedColumns[] = new SortColumn('continent', 'ASC');
    ...
    try
    {
        $Page = new v_data_sorting_initial_orderPage("v_data_sorting_initial_order", "data_sorting_default_sort_order.php", GetCurrentUserPermissionsForPage("v_data_sorting_initial_order"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_data_sorting_initial_order"));
