 ...
 */
    ...
    class data_sources_non_updatable_queryPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Data Sources.Non-Updatable Query');
            $this->SetMenuLabel('Non-Updatable Query');
            ...
            $this->dataset = new QueryDataset(
              ...
              $selectQuery, $insertQuery, $updateQuery, $deleteQuery, 'data_sources_non_updatable_query');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_sources_non_updatable_query.html"));
        }
    ...
    try
    {
        $Page = new data_sources_non_updatable_queryPage("data_sources_non_updatable_query", "data_sources_non_updatable_query.php", GetCurrentUserPermissionsForPage("data_sources_non_updatable_query"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("data_sources_non_updatable_query"));
