 ...
 */
    ...
    class customerPage extends Page
    {
        ...
        {
            $this->SetTitle('Data Sources.Table');
            $this->SetMenuLabel('Table');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_sources_table.html"));
        }
    ...
    try
    {
        $Page = new customerPage("customer", "data_sources_table.php", GetCurrentUserPermissionsForPage("customer"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("customer"));
