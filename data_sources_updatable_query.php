 ...
 */
    ...
    class data_sources_updatable_queryPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Data Sources.Updatable Query');
            $this->SetMenuLabel('Updatable Query');
    
            $selectQuery = 'SELECT * FROM customer';
            $insertQuery = array('INSERT INTO 
              customer (first_name, last_name, birthday, email) 
            VALUES 
            ...
            WHERE 
              id = :OLD_id');
            $deleteQuery = array('DELETE FROM customer 
            WHERE id = :id');
            $this->dataset = new QueryDataset(
              MySqlIConnectionFactory::getInstance(), 
              GetConnectionOptions(),
              $selectQuery, $insertQuery, $updateQuery, $deleteQuery, 'data_sources_updatable_query');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/data_sources_updatable_query.html"));
        }
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'address_id', 'address_id_caption', 'Address Id')
            );
        }
    ...
    try
    {
        $Page = new data_sources_updatable_queryPage("data_sources_updatable_query", "data_sources_updatable_query.php", GetCurrentUserPermissionsForPage("data_sources_updatable_query"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("data_sources_updatable_query"));
