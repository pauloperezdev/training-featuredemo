 ...
 */
    ...
    class v_editors_cascading_comboboxPage extends Page
    {
        ...
        protected function doRegisterHandlers() {
            ...
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_v_editors_cascading_combobox_address_id_search', 'id', 'caption', null, 20);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_v_editors_cascading_combobox_address_id_level0NestedPage_Capital_search', 'ID', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_v_editors_cascading_combobox_address_id_level1NestedPage_CountryCode_search', 'Code', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
