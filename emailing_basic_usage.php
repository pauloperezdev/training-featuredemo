 ...
 */
    ...
    class v_emailing_basic_usagePage extends Page
    {
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('last_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_v_emailing_basic_usage_customer_id_search', 'id', 'last_name', '%first_name% %last_name%', 20);
            ...
            $lookupDataset->setOrderByField('last_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_v_emailing_basic_usage_customer_id_search', 'id', 'last_name', '%first_name% %last_name%', 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('last_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_v_emailing_basic_usage_customer_id_search', 'id', 'last_name', '%first_name% %last_name%', 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('last_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_v_emailing_basic_usage_customer_id_search', 'id', 'last_name', '%first_name% %last_name%', 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
