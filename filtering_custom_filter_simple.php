 ...
 */
    ...
    class v_filtering_custom_filterPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Filtering.Custom Filter (Simple Version)');
            $this->SetMenuLabel('Custom Filter - 1');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_filtering_custom_filter`');
        ...
        {
            return '$(\'.js-reset-custom-filter\').on(\'click\', function() {'. "\n" .
            '    window.location = $.query.set(\'simpleLifeExpectancyFilter\', \'\');'. "\n" .
            '    return false;'. "\n" .
            '});';
        }
    ...
    try
    {
        $Page = new v_filtering_custom_filterPage("v_filtering_custom_filter", "filtering_custom_filter_simple.php", GetCurrentUserPermissionsForPage("v_filtering_custom_filter"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_filtering_custom_filter"));
