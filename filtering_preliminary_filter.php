 ...
 */
    ...
    class v_filtering_ask_conditionPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Filtering.Preliminary Filter');
            $this->SetMenuLabel('Preliminary Filter');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_filtering_ask_condition`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/filtering_ask_condition.html"));
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_v_filtering_ask_condition_Capital_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Capital', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_v_filtering_ask_condition_Capital_search');
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_v_filtering_ask_condition_Capital_search', 'ID', 'Name', null, 20);
    ...
    try
    {
        $Page = new v_filtering_ask_conditionPage("v_filtering_ask_condition", "filtering_preliminary_filter.php", GetCurrentUserPermissionsForPage("v_filtering_ask_condition"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_filtering_ask_condition"));
