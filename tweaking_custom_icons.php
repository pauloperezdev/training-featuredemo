 ...
 */
    ...
    class v_tweaking_custom_iconsPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Fine-tuning & Tweaking.Custom Icons');
            $this->SetMenuLabel('Custom Icons');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_tweaking_custom_icons`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/tweaking_custom_icons.html"));
            $this->setDetailedDescription(extractLessCode('CustomIconsPage', 'user'));
        }
        ...
        protected function CreateGrid()
        {
            ...
            $defaultSortedColumns[] = new SortColumn('Continent', 'DESC');
    ...
    try
    {
        $Page = new v_tweaking_custom_iconsPage("v_tweaking_custom_icons", "tweaking_custom_icons.php", GetCurrentUserPermissionsForPage("v_tweaking_custom_icons"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_tweaking_custom_icons"));
