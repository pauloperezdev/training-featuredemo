 ...
 */
    ...
    class v_tweaking_custom_themePage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Fine-tuning & Tweaking.Custom Theme');
            $this->SetMenuLabel('Custom Theme');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_tweaking_custom_theme`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/tweaking_custom_theme.html"));
        }
    ...
    try
    {
        $Page = new v_tweaking_custom_themePage("v_tweaking_custom_theme", "tweaking_custom_theme.php", GetCurrentUserPermissionsForPage("v_tweaking_custom_theme"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_tweaking_custom_theme"));
