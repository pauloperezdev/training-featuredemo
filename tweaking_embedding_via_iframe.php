 ...
 */
    ...
    class v_tweaking_embedding_via_iframePage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Embedded Page');
            $this->SetMenuLabel('Page Embedding');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`v_tweaking_embedding_via_iframe`');
        ...
        protected function DoPrepare() {
            $this->setDescription(file_get_contents("external_data/doc/tweaking_embedding_via_iframe.html"));
        ...
        protected function doGetCustomTemplate($type, $part, $mode, &$result, &$params)
        {
            if ($part == PagePart::Layout) {
                $result = 'embedding_custom_layout.tpl';
            }
        }
    ...
    try
    {
        $Page = new v_tweaking_embedding_via_iframePage("v_tweaking_embedding_via_iframe", "tweaking_embedding_via_iframe.php", GetCurrentUserPermissionsForPage("v_tweaking_embedding_via_iframe"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("v_tweaking_embedding_via_iframe"));
