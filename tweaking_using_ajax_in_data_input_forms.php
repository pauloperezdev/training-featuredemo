 ...
 */
    ...
    class v_tweaking_ajax_using_invoice_detailPage extends DetailPage
    {
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('product_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_v_tweaking_ajax_using_invoice_detail_product_id_search', 'id', 'product_name', null, 20);
            ...
            $lookupDataset->setOrderByField('product_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_v_tweaking_ajax_using_invoice_detail_product_id_search', 'id', 'product_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('product_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_v_tweaking_ajax_using_invoice_detail_product_id_search', 'id', 'product_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('product_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_v_tweaking_ajax_using_invoice_detail_product_id_search', 'id', 'product_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class v_tweaking_ajax_usingPage extends Page
    {
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('customer_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_v_tweaking_ajax_using_customer_id_search', 'id', 'customer_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('customer_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_v_tweaking_ajax_using_customer_id_search', 'id', 'customer_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('customer_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_v_tweaking_ajax_using_customer_id_search', 'id', 'customer_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('customer_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_v_tweaking_ajax_using_customer_id_search', 'id', 'customer_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
